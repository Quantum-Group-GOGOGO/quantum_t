...
if __name__ == "__main__":
    ...
    dataset = TimeSeriesDataset(df, sequence_length_1, sequence_length_10,
                                sequence_length_60, sequence_length_240, sequence_length_1380)

    dataloader = DataLoader(dataset, batch_size=64, shuffle=True, num_workers=0)

    # 查看一个样本
    #sample_close_1, sample_close_10, sample_close_60, sample_close_240, sample_close_1380, sample_volume_1, sample_volume_10, sample_volume_60, sample_volume_240, sample_volume_1380, sample_other, sample_evaluation = next(iter(dataloader))
